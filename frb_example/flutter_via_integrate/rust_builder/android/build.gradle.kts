...
group = "com.flutter_rust_bridge.rust_lib_flutter_via_integrate"
version = "1.0"
...
configure<LibraryExtension> {
    namespace = "com.flutter_rust_bridge.rust_lib_flutter_via_integrate"
...
extensions.getByName("cargokit").apply {
    ...
    javaClass.getMethod("setLibname", String::class.java).invoke(this, "rust_lib_flutter_via_integrate")
}
