...
group = "com.flutter_rust_bridge.rust_lib_frb_example_integrate_third_party"
version = "1.0"
...
configure<LibraryExtension> {
    namespace = "com.flutter_rust_bridge.rust_lib_frb_example_integrate_third_party"
...
extensions.getByName("cargokit").apply {
    ...
    javaClass.getMethod("setLibname", String::class.java).invoke(this, "rust_lib_frb_example_integrate_third_party")
}
